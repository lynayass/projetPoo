...
public class WindowBien extends JFrame {
    public  static final ArrayList<Agents> agents = new ArrayList<>();
    public static final ArrayList<Bien> biens = new ArrayList<>();
    public ArrayList<RendezVous> rendezVousList = new ArrayList<>();
    ...
    public   WindowBien() {
        ...
        afficherButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (biens.isEmpty()) {
                    JOptionPane.showMessageDialog(WindowBien.this, "Aucun bien disponible.");
                } else {
                    StringBuilder biensList = new StringBuilder("Les biens : \n");
                    for (int i = 0; i < biens.size(); i++) {
                        biensList.append(i + 1).append(": ").append(biens.get(i)).append("\n");
                    }
                    JOptionPane.showMessageDialog(WindowBien.this, biensList.toString());
                }
            }
        });
        ...
        supprimerButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (biens.isEmpty()) {
                    JOptionPane.showMessageDialog(WindowBien.this, "Aucun bien disponible à supprimer.");
                    return;
                }
                ...
                try {
                    ...
                    if (index < 0 || index >= biens.size()) {
                        JOptionPane.showMessageDialog(WindowBien.this, "Index invalide !");
                        return;
                    }
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(WindowBien.this, "Veuillez entrer un nombre valide.");
                    return;
                }

                biens.remove(index);
                JOptionPane.showMessageDialog(WindowBien.this, "Bien supprimé.");
            }
        });
        ...
        rechercherButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (biensTrouves.isEmpty()) {
                    JOptionPane.showMessageDialog(WindowBien.this, "Aucun bien trouvé.");
                } else {
                    ...
                    JOptionPane.showMessageDialog((Component) WindowBien.this, biensList.toString());
                }
            }
        });
        ...
        affecterButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (biens.isEmpty()) {
                    JOptionPane.showInputDialog(WindowBien.this, "Aucun bien disponible à affecter.");
                    return;
                }
                ...
                agents.add(agent);
                JOptionPane.showMessageDialog(WindowBien.this, "Agent ajouté.");
                ...
                try {
                    ...
                    if (position < 0 || position >= biens.size()) {
                        JOptionPane.showMessageDialog(WindowBien.this, "Position invalide !");
                        return;
                    }
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(WindowBien.this, "Veuillez entrer un nombre valide.");
                ...
                JOptionPane.showMessageDialog(WindowBien.this, "Bien affecté.\nLes biens de l'agent : " + agent.getNom() + " " + agent.getPrenom());
            }
        });
        ...
        prendreRendezVousButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(WindowBien.this, "Rendez-vous pris avec " + agentNom + " " + agentPrenom + " le " + date + " à " + heure);
            }
        });
        afficherRendezVousButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (rendezVousList.isEmpty()) {
                    JOptionPane.showMessageDialog(WindowBien.this, "Aucun rendez-vous disponible.");
                } else {
                    ...
                    JOptionPane.showMessageDialog(WindowBien.this, rendezVousListStr.toString());
                }
            }
        });
